...
//! use rml_ui_term::mouse::{pixel_to_cell, mouse_button_report};
//!
...
/// use rml_ui_term::mouse::pixel_to_cell;
///
/// let position = point(px(100.0), px(50.0));
/// let origin = point(px(10.0), px(10.0));
...
///
/// ```
/// use rml_ui_term::mouse::{selection_type_from_clicks, SelectionType};
///
...
/// use alacritty_terminal::term::TermMode;
/// use alacritty_terminal::index::{Point, Line, Column};
/// use rml_ui_term::mouse::mouse_button_report;
///
/// let point = Point::new(Line(5), Column(10));
/// let mode = TermMode::MOUSE_REPORT_CLICK;
///
...
/// use alacritty_terminal::term::TermMode;
/// use alacritty_terminal::index::{Point, Line, Column};
/// use rml_ui_term::mouse::scroll_report;
///
/// let point = Point::new(Line(5), Column(10));
/// let mode = TermMode::MOUSE_REPORT_CLICK;
///
...
///
/// ```
/// use rml_ui_term::mouse::encode_modifiers;
///
...
/// ```
/// use gpui::px;
/// use rml_ui_term::mouse::pixels_to_scroll_lines;
///
/// let cell_height = px(20.0);
