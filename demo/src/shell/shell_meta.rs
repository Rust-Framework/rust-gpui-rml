...
#[contribute(host_id = "demo.shell", id = "cat.components", name = "tree.cat.components", kind = "case", order = 10)]
#[derive(Default)]
pub struct CatComponents;

#[contribute(host_id = "demo.shell", id = "cat.menu", name = "tree.cat.menu", kind = "case", order = 15)]
#[derive(Default)]
pub struct CatMenu;

#[contribute(host_id = "demo.shell", id = "cat.i18n", name = "tree.cat.i18n", kind = "case", order = 20)]
#[derive(Default)]
pub struct CatI18n;
